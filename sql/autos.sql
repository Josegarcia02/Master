...
INSERT INTO `mantenimiento`(`marca`,`placa`,`serie`,`num_inventario`,`fecha`,`mantenimiento`,`observaciones`,`id_vehiculo`)
VALUE ('FORD','37UDHF','37EUEHJRUE848','I3484UDJRJRRJDJD','2019-05-10','CAMBIO DE LLANTAS','BUENAS CONDICIONES',1);

INSERT INTO `inventario` (`tcirculacion`, `poliza_seguro`, `num_inventario`,`vehiculo_tipo`, `color`,`accesorios`, `carroceria`,`observaciones`,`id_vehiculo`)
VALUE ('74HE7474','73YSGEJE3','736WH36HE','CAMIONETA','AZUL','LLANTAS','GOLPEADA','NINGUNA',1 );